...
export default function ClientesEmptyState({ onCreate }: { onCreate: () => void }) {
  return (
    <div className="flex flex-1 items-center justify-center py-16">
      ...
      >
        <div className="bg-accent-soft flex h-12 w-12 shrink-0 items-center justify-center rounded-xl">
          <Users className="text-foreground h-6 w-6" strokeWidth={1.75} />
        </div>

        <div className="space-y-1.5">
          <h2 className="text-lg font-semibold tracking-tight">Aún no tienes clientes</h2>
          <p className="text-muted-foreground text-sm">
            Crea tu primer cliente para empezar a organizar la relación comercial del estudio.
          </p>
        </div>
